...
@Service
public class ServicioEmpleado implements ServiciosBase <Empleado> {
    ...
    public List<Empleado> buscarTodos() throws Exception {
        try {
            List<Empleado> empleados = repositorioEmpleado.findAll(); //se crea una variable local que almacena //repositorio busca datos
            return empleados;
...
//implements es para implementar la interface